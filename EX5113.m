...
% using linear triangular elements and backward difference method
...
fsol=zeros(sdof,1);     % initialization of solution vector
...
sol(1,1)=fsol(8);  % sol contains time-history solution of node 8
sol(2,1)=fsol(9);  % sol contains time-history solution of node 9 
...
sol(1,it+1)=fsol(8);  % sol contains time-history solution of node 8
sol(2,it+1)=fsol(9);  % sol contains time-history solution of node 9 
