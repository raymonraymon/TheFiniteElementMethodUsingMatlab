%----------------------------------------------------------------------
%
%  This program {\it obssim.m} demonstrates a dynamic observer 
...
%  Use the {\it flqr.m} function to design the observer gain

[L,S]=felqr(A',C',eye(8),0.01);

% Now build the total closed-loop system for both system and observer

Atot=[A, 0*eye(8);L'*C, A-L'*C];
Btot=[B;B];
Ctot=eye(16);
Dtot=eye(16,1);
...
%  Use MATLAB function {\it frlresp.m} to simulate the total system
