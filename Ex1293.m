...
%   u'' - alpa*u*u'= 0,  0 < x < 1                                                                        
%   u(0) = 0  and  u(1) = 1
% using classical linearization such as u*u'.
%
...
alpa=10;      % coefficient of the nonlinear term
...
k(1,1)=1/eleng-alpa*(2*soll+solr)/6; % element matrix
k(1,2)=-1/eleng+alpa*(2*soll+solr)/6;
k(2,1)=-1/eleng-alpa*(soll+2*solr)/6;
k(2,2)=1/eleng+alpa*(soll+2*solr)/6;
...
No_of_Interation=it % number of iteration for convergency
